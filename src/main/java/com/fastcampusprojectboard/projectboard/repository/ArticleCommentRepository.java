...
import com.fastcampusprojectboard.projectboard.domain.QArticleComment;
...
public interface ArticleCommentRepository extends
        ...
        QuerydslPredicateExecutor<ArticleComment>, // 엔티티 안에 있는 기본 검색 기능 추가
    ...
    default void customize(QuerydslBindings bindings, QArticleComment root){
        ...
        bindings.including(root.content, root.createdAt, root.createdBy); // 원하는 필드만 설정
